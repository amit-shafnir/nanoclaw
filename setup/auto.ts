...
// ollama installs via its own /add-* skill. Each is installed by its
// self-contained setup/add-<name>.sh.
const INSTALLABLE_PROVIDERS = [
  { value: 'codex', label: 'Codex', hint: 'OpenAI — ChatGPT subscription or API key' },
  { value: 'opencode', label: 'OpenCode', hint: 'OpenRouter / DeepSeek / Anthropic / Zen — API key' },
] as const;
